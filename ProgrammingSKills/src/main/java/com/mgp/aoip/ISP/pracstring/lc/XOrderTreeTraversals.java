...
public class XOrderTreeTraversals {
    ...
    public static void main(String[] args) {
        ...
        TreeNode l0L = new TreeNode(0);
        TreeNode l0 = new TreeNode(1, l0L,l0R );
        ...
        postOrderTraversalRecursive(l0).forEach(System.out::println);

        System.out.println("Recursive inOrder-> ");
        inOrderTraversalRecursive(l0).forEach(System.out::println);
//        System.out.println("Iterative Order-> ");
//        postOrderTraversalIterative(l0).forEach(System.out::println);
    }
}
